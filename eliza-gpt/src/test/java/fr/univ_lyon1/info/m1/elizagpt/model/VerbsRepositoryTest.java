...
import fr.univ_lyon1.info.m1.elizagpt.model.grammar.verb.*;
    ...
    @Test
     void testVerbsRepository() {
        try {
            ...
            VerbsRepository verbsRepository = new VerbsRepository(Objects.requireNonNull(getClass().getResource("/vocabulary/vocabulary.xml")).toExternalForm());
